...
hpcx_load
#module load gdrcopy cuda cmake ninja nccl binutils hpcx-mt
...
export PATH=/nlsasfs/home/gpucbh/gpucbh-pr/dftfeDependencies/dftfe/dftfe_workshopBranch/install/complex:$PATH

# Launch with GPU–NIC binding
nvidia-smi

mpirun -n $SLURM_NTASKS ./bind_ompi.sh dftfe parameterFileNSCF.prm >nscf_45.out
